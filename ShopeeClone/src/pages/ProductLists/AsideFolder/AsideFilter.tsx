  ...
  return (
    <div className='py-4'>
      ...
      <div className='bg-gray-300 my-4'>
        <ul>
          <li className='py-2'>
            <Link to={path.home} className='flex text-orange font-semibold'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
          ...
          <li>
            <Link to={path.home} className='flex px-6'>
              Thời trang nam
            </Link>
          </li>
        </ul>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2'>
          ...
          <Button type='submit' className='w-full p-2 uppercase bg-orange text-white text-sm hover:bg-orange'>
            Áp dụng
          </Button>
        </form>
      </div>
